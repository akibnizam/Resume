...
angular.module("Resume", ["ngMaterial"]).directive("resume", function () {
    ...
    return {
        ...
        template: '<div class="header">\n      <div class="page-title-container">\n        <h1 class="page-title page-title-first">{{firstName}}</h1>\n        <h1 class="page-title page-title-last">{{lastName}}</h1>\n      </div>\n      <div class="header-icons">\n        <span ng-if="phone" class="md-subhead page-subhead"><i class="fa fa-lg fa-phone"></i>{{phone}}</span>\n        <a style="text-decoration: none; color:inherit" href="mailto:abn9@gatech.edu"><span ng-if="email" class="md-subhead page-subhead"><i class="fa fa-lg fa-envelope"></i>{{email}}</span></a>\n        <a href="https://github.com/akibnizam" style="text-decoration: none; color:inherit"><span ng-if="github" class="md-subhead page-subhead"><i class="fa fa-lg fa-github"></i>{{github}}</span></a>\n        <a href="https://jonlian.com" style="text-decoration: none; color:inherit"><span ng-if="website" class="md-subhead page-subhead"><i class="fa fa-lg fa-globe"></i>{{website}}</span></a>\n<a href="https://www.linkedin.com/in/akibnizam" style="text-decoration: none; color:inherit"><span ng-if="linkedin" class="md-subhead page-subhead"><i class="fa fa-lg fa-linkedin-square"></i>{{linkedin}}</span></a>\n      </div>\n    </div>'
    }
